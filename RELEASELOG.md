...
- feat: **support 6000.5.x**
- fix: handle invalid nested type name which contains namespace in custom attribute generated by burst, which lead to TypeNameParser::Parse fail
- fix(tuanjie): Class::SetupEventsLocked call SetupMethods when disable IL2CPP_ENABLE_LAZY_INIT

### Editor

- feat: installer support 6000.5.x
